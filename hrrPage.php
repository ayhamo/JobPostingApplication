...
<form id="newForm" class="form" style="display: none" method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
    ...
    <div style="text-align: center;margin-bottom: 7px">Contract Type<br>
        ...
        <label>
            <input type="radio" name="conttype" id="in" value="IN" onchange="disablemindays()">
            Internship</label>
    </div>
    ...
    <label>Internship Min Days: </label><input id="inmin" type="number" name="cid" style="width: 103px" disabled>
    <br>
